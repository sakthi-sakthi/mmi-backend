                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <input type="date" name="eventdate" value="{{ old('eventdate') ?? $value->eventdate ?? date('Y-m-d') }}" id="eventdate" value="{{ old('title') ?? $value->eventdate }}" class="form-control form-control-sm @error('eventdate') is-invalid @enderror">
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header">
