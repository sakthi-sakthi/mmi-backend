...
elseif (isset($value)) {
    $seo_title = $value->getSlug->seo_title;
    $seo_description = $value->getSlug->seo_description;
    $no_index = $value->getSlug->no_index;
    $no_follow = $value->getSlug->no_follow;
} else {
    $seo_title = '';
    $seo_description = '';
    $no_index = 0;
...
<div class="card">
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <textarea class="form-control form-control-sm" rows="3" id="seo_description"
                    name="seo_description">{{ old('content') ?? $seo_description }}</textarea>
                <div class="input-group-append">
        ...
        <div class="custom-control custom-checkbox">
            <input class="custom-control-input" type="checkbox" @if ($no_follow == 1) checked @endif id="no_follow"
                name="no_follow">
