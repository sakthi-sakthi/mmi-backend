                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=""><a href="{{ url('/messages/'. $value->file_id ) }}" download="download">{{ $value->file_id }}</a></div>
                                        @error('file_id')
                                    ...
                                    <div class="form-group">
                                        <select class="form-control form-control-sm" id="category" name="category">
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" @if (old('category') ?? $value->category_id == $category->id) selected @endif>
