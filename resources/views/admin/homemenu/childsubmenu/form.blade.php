    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">@if(Request::segment(3)=="create") {{ __('main.AddchildSubmenu') }} @else {{ __('main.EditchildSubmenu') }} @endif </h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">{{ __('main.Home') }}</a>
                            </li>
                            <li class="breadcrumb-item active"><a href="{{ route('admin.childsubmenu.index') }}">{{ __('main.childsubmenu') }}</a></li>
                            <li class="breadcrumb-item active">@if(Request::segment(3)=="create") {{ __('main.AddchildSubmenu') }} @else {{ __('main.EditchildSubmenu') }} @endif</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div class="content">
            <div class="container-fluid">
                    <form action="@if(Request::segment(3)=="create") {{ route('admin.childsubmenu.store') }} @else {{ route('admin.childsubmenu.update',$editsubmenu->id ) }} @endif" method="post" id="form">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <label for="title" id="label">{{__('main.childsubmenu')}}</label>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                        <div class="col-md-6">
                            ...
                            <div class="card" id="save-card">
                                <div class="card-body">
                                    <a href="javascript:void(0);" class="btn btn-success btn-sm float-right"
                                        ...
                                        <a href="{{ route('admin.childsubmenu.index') }}" class="btn btn-danger btn-sm float-right mr-2">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
