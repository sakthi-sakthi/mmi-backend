...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid"> 
                <form action="{{ route('admin.news_events.store') }}" method="post" id="form" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body"> 
                                    <input type="date" name="eventdate" id="eventdate" value="{{ old('eventdate') ?? date('Y-m-d') }}" class="form-control form-control-sm @error('eventdate') is-invalid @enderror">
                                </div>
                            </div>
                        </div>
